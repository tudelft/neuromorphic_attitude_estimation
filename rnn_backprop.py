...
# from modelmodule.norse_model_loihi_v2 import SNNLoihi as SNN
# from modelmodule.norse_model import SNN
from datamodule.data_loader import load_datasets
from trainingmodule.rnn_training_backprop import fit
from utils.option_dicts import loss_functions, optimizers, network_types

if __name__ == "__main__":
    parser = ArgumentParser()
    parser.add_argument("--config", type=str, default="configs/config_rnn_backprop.yaml")
